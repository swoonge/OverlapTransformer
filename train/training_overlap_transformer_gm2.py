...
class trainHandler():
    def __init__(self, height=64, width=900, channels=5, norm_layer=None, use_transformer=True, lr = 0.001,
        ...
        self.resume = True
        self.save_name = "/home/vision/GD_model/OverlapTransformer/weights/pretrained_overlap_transformer61.pth.tar"
    ...
    def train(self):
        ...
        for i in range(starting_epoch+1, epochs): # epochs
            ...
            for j in trange(len(self.train_imgf1)):
                """
            ...
            self.save_name = "../gm_weights/" + "lr" + str(self.learning_rate) + "_pretrained_overlap_transformer"+str(i)+".pth.tar"
...
if __name__ == '__main__':
    ...
    """
    train_handler = trainHandler(height=64, width=900, channels=1, norm_layer=None, use_transformer=True, lr=0.0000001,
